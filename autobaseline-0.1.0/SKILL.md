...
2. Explicitly ask: "Phase X complete. Please review `baselines/reports/phase_X_{name}_report.md`. Reply 'confirm' to proceed to Phase X+1, or provide feedback for changes."
